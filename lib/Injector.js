 ...
 * @param {string} basename The basename of the loaded module. (The basename is the default module name.)
 ...
 * });
 */
var Injector = function (nameMaker) {
    this._nameMaker = nameMaker;
    this._graph = {};
...
Injector.prototype.registerPath = function (patterns, globOptions) {
    ...
    files.forEach(function (file) {
        ...
        var name = (this._nameMaker && this._nameMaker(basename, file, fn)) || fn.$name || basename;
